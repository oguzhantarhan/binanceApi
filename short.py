...
stop_loss_order = client.futures_create_order(symbol=symbol,side='BUY', type='STOP', stopPrice = sl, quantity = quantity, price = sltimeInForce='GTE_GTC')
take_profit_order = client.futures_create_order(symbol=symbol,side='BUY', type='TAKE_PROFIT', stopPrice = tp, quantity = quantity, price = tptimeInForce='GTE_GTC')
